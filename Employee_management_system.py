...
def Add_Employ():
    ...
    data = (Id, Name, Phone_no, Address, Salary)
    # Instering Employee Details in
    # the Employee (empdata) Table
    sql = 'insert into empdata values(%s,%s,%s,%s,%s)'
    c = con.cursor()
...
def Update_Employ():
    ...
    if(check_employee(Id) == False):
        ...
        sql = 'UPDATE empdata set Phone_no = %s, Address = %s where Id = %s'
